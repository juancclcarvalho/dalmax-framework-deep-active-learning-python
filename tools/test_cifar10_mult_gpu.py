...
# Definir a estratégia de distribuição para múltiplas GPUs
...
with strategy.scope():
    # Definir o modelo (ResNet50 como exemplo)
...
if not os.path.exists('reports'):
    os.makedirs('reports')
with PdfPages('reports/cifar10_training_report.pdf') as pdf:
    pdf.savefig(plt.figure(1))
    pdf.savefig(plt.figure(2))

print("Relatório completo foi salvo em 'reports/cifar10_training_report.pdf'")
